...
var cli = nomnom.help(
	...
	influxdbHost: {
		metavar: '<HOST>',
		help: 'The InfluxDB host.'
	},
	influxdbPort: {
		metavar: '<INTEGER>',
		default: defaultConfig.influxdbPort,
		help: 'The InfluxDB port.'
	},
	influxdbDatabase: {
		metavar: '<Database>',
		default: defaultConfig.influxdbDatabase,
		help: 'The destination InfluxDB database.'
	},
	influxdbNamespace: {
		metavar: '<NAMESPACE>',
		default: defaultConfig.influxdbNamaspace,
		help: 'A custom namespace for the datas sent to InfluxDB.'
	},
	influxdbData: {
		default: defaultConfig.graphiteData,
		help: 'Choose which data to send to InfluxDB by a comma separated list. Default all data is sent. [summary,rules,pagemetrics,timings,requests]'
	},
	gpsiKey: {
